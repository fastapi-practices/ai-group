set @ai_buddy_menu_id = (select id from sys_menu where name = 'PluginAIBuddy');

insert into sys_menu (id, title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
values (2147098509659213900, 'ai-buddy-group.menu', 'AIBuddyGroupManage', '/plugins/ai-buddy/group', 9, 'material-symbols:group-outline', 1, '/plugins/ai-buddy-group/views/index', null, 1, 1, 1, '', null, @ai_buddy_menu_id, now(), null);
