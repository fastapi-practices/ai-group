...
values (2147098509659213900, 'ai-buddy-group.menu', 'AIGroupManage', '/plugins/ai-buddy/group', 7, 'material-symbols:group-outline', 1, '/plugins/ai-buddy-group/views/index', null, 1, 1, 1, '', null, @ai_menu_id, now(), null);
