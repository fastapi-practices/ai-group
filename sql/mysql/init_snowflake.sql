set @ai_menu_id = (select id from sys_menu where name = 'PluginAI');

insert into sys_menu (id, title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
values (2147098509659213900, '分组管理', 'AIGroupManage', '/plugins/ai/group', 7, 'material-symbols:group-outline', 1, '/plugins/ai-group/views/index', null, 1, 1, 1, '', null, @ai_menu_id, now(), null);
