...
values (2147098509659213900, '分组管理', 'AIGroupManage', '/plugins/ai_buddy/group', 7, 'material-symbols:group-outline', 1, '/plugins/ai_buddy_group/views/index', null, 1, 1, 1, '', null, @ai_menu_id, now(), null);
